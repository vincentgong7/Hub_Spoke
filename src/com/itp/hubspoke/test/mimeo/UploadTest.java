...
//		httpGet.addHeader("Content-Type", "application/json");
	...
	private void findStoreItems_old() throws ClientProtocolException, IOException {
		CredentialsProvider provider = new BasicCredentialsProvider();
		UsernamePasswordCredentials credentials = new UsernamePasswordCredentials("vincent.gong@itpreneurs.com", "itis,that");
		provider.setCredentials(AuthScope.ANY, credentials);
...
//		String jsonString = "{\"Name\":\"Presentation\",\"Type\":\"‘Printfile’\",\"LevelOfDetail\":0,\"IncludeSubFolders\":false,\"FolderScope\":0}";
//		String jsonString = "{\"PageInfo\":{\"PageSize\":20,\"PageNumber\":1},\"Name\":\"word2007\",\"LevelOfDetail\":0,\"IncludeSubFolders\":false,\"FolderScope\":0}";
		String jsonString = "{\"PageInfo\":{\"PageSize\":20,\"PageNumber\":1},\"Name\":\"test32.pdf\",\"LevelOfDetail\":0,\"IncludeSubFolders\":false,\"FolderScope\":0}";
	...
	private void findStoreItems() throws ClientProtocolException, IOException {
		MimeoClient mc = new MimeoClient(MimeoClient.HttpMethod.HTTP_METHOD_POST, MimeoClient.BodyType.JSON, MimeoClient.BodyType.JSON);
		mc.setApi("https://connect.sandbox.mimeo.com/2012/02/StorageService/FindStoreItems");
		String requestBody = "{\"PageInfo\":{\"PageSize\":20,\"PageNumber\":1},\"Name\":\"test32.pdf\",\"LevelOfDetail\":0,\"IncludeSubFolders\":false,\"FolderScope\":0}";
	...
	private void QuoteItem_old() throws ClientProtocolException, IOException {
		CredentialsProvider provider = new BasicCredentialsProvider();
		UsernamePasswordCredentials credentials = new UsernamePasswordCredentials("vincent.gong@itpreneurs.com", "itis,that");
		provider.setCredentials(AuthScope.ANY, credentials);
...
//		String requestBody = "<Document xmlns=\"http://schemas.mimeo.com/MimeoConnect/2012/02/Orders\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Id>00000000-0000-0000-0000-000000000000</Id><Name>test20-1.pdf</Name><Description /><ReferenceData /><Product><ApplicationId>00000000-0000-0000-0000-000000000000</ApplicationId><Quantity>0</Quantity><Template>Custom</Template><DocumentTemplateId>7742e638-b597-444a-a8fc-5e994e3896ef</DocumentTemplateId><DocumentTemplateName>word2007doc</DocumentTemplateName><Content><DocumentSection><Source>f5ee773e-5a94-43e2-93d1-8dfc059c6389</Source><Range>[1,10]</Range></DocumentSection></Content></Product></Document>";
		String requestBody = "<Document xmlns=\"http://schemas.mimeo.com/MimeoConnect/2012/02/Orders\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Id>00000000-0000-0000-0000-000000000000</Id><Name>test20-2-no_range.pdf</Name><Description /><ReferenceData /><Product><ApplicationId>00000000-0000-0000-0000-000000000000</ApplicationId><Quantity>0</Quantity><Template>Custom</Template><DocumentTemplateId>7742e638-b597-444a-a8fc-5e994e3896ef</DocumentTemplateId><DocumentTemplateName>word2007doc</DocumentTemplateName><Content><DocumentSection><Source>f5ee773e-5a94-43e2-93d1-8dfc059c6389</Source></DocumentSection></Content></Product></Document>";
